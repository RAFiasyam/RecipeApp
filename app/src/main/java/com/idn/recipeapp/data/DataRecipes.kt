package com.idn.recipeapp.data
...
object DataRecipes {
    ...
    val listBreakfast: ArrayList<Recipes>
        get() {
            ...
            for (position in nameBreakfast.indices) {
                val recipes = Recipes(
                    ...
                    photo = photoBreakfast[position],
                    price = priceBreakfast[position],
    ...
    val listVegetarian: ArrayList<Recipes>
        get() {
            ...
            for (position in nameVegetarian.indices) {
                val recipes = Recipes(
                    ...
                    photo = photoVegetarian[position],
                    price = priceVegetarian[position],
    ...
    val listDessert: ArrayList<Recipes>
        get() {
            ...
            for (position in nameDessert.indices) {
                val recipes = Recipes(
                    ...
                    photo = photoDessert[position],
                    price = priceDessert[position],
